...
export default async function Quiz({ searchParams }: { searchParams: { category: string | null, difficulty: string | null } }) {
    ...
    const extendedData: ExtendedQuizQuestion[] = data.results.map((question: ExtendedQuizQuestion) => ({
        ...question,
